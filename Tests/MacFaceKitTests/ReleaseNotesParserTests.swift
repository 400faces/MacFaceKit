...
/// The update dialog's "What's new" list is only as good as the parser that feeds it. Sparkle hands the
/// app release notes in three shapes — embedded markdown, embedded plain-text, or downloaded HTML — and
